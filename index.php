    ...
    <section class="section-margin">
      ...
      <div class="col-lg-12 danger text-center zero-panel">
        ...
        <ul class="list-inline" id="chart-skill">
          <li><a href="pembimbing/login.php" target="_blank"><button class="btn btn-warning" style="size: 50px;">Login Pembimbing</button></a>
          </li><br>
          <li><a href="mahasiswa/login_mahasiswa.php" target="_blank"><button class="btn btn-primary" style="size: 50px;">Login Mahasiswa</button></a>
          </li>
        </ul>
      </div>
    </div>

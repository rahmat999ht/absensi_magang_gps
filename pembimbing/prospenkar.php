                            ...
                            <div class="table-responsive table--no-card m-b-30">
                                <table class="table table-borderless table-striped table-earning">
                                    ...
                                    <tbody>
                                        <?php
                                        $cari = $_POST['cari'];
                                        $sql = "SELECT * FROM tb_mahasiswa WHERE id_mahasiswa LIKE '%$cari%' OR nama LIKE '%$cari%'";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a href="karyawan_edit.php?id_mahasiswa=<?php echo $row['id_mahasiswa']; ?>"><button class="btn btn-primary">Ubah</button></a> <a href="hapus.php?id_mahasiswa=<?php echo $row['id_mahasiswa']; ?>"><button class="btn btn-danger" onclick="return confirm('yakin ingin dihapus?');">Hapus</button></a></td>
                                            </tr>
                                        <?php
                                            $no++;
                                        }
